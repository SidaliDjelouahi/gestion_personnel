...
<div class="container mt-4">
    <h2 class="mb-3"><i class="fa fa-exchange-alt"></i> Nouvelle Mutation</h2>
    ...
    <!-- Formulaire ajout mutation -->
    <form method="post" class="card p-3 shadow-sm">

        <!-- Employé avec moteur de recherche AJAX -->
        <div class="mb-3 position-relative">
            <label class="form-label">Employé</label>
            <input type="text" id="rechercheEmploye" class="form-control" placeholder="Nom ou prénom..." autocomplete="off">
        ...
        <!-- Nouveau Grade (facultatif) -->
        <div class="mb-3">
            <label class="form-label">Nouveau Grade (optionnel)</label>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    input.addEventListener("keyup", function() {
        ...
        fetch("../carriere/recherche_employe.php?q=" + encodeURIComponent(query))
            .then(res => res.json())
            .then(data => {
                resultsDiv.innerHTML = "";
                data.forEach(emp => {
